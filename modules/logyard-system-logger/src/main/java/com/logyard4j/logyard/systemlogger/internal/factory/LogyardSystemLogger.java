...
import com.logyard4j.logyard.systemlogger.internal.event.SystemLevelMapper;
import com.logyard4j.logyard.systemlogger.internal.event.SystemMessageRenderer;
...
public final class LogyardSystemLogger implements System.Logger {
    ...
    private void publish(
        ...
        try {
            com.logyard4j.logyard.api.Level logyardLevel = SystemLevelMapper.toLogyard(sourceLevel);
            LogEventIngress logger = runtime.runtime().logger(name);
