 ...
 * {@link com.logyard4j.logyard.api.spi.output.EventSink} has a managed close callback; context providers, processors, formatters, and encoders must not own
 ...
 */
package com.logyard4j.logyard.api.spi;
