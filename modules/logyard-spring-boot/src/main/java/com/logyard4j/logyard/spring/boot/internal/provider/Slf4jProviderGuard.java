package com.logyard4j.logyard.spring.boot.internal.provider;
...
public final class Slf4jProviderGuard {
    ...
    private static final String LOGYARD_PROVIDER = "com.logyard4j.logyard.slf4j.LogyardServiceProvider";
