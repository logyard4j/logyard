package com.zsumz.logyard.spring.boot.internal.provider;
...
public final class Slf4jProviderGuard {
    ...
    private static final String LOGYARD_PROVIDER = "com.zsumz.logyard.slf4j.LogyardServiceProvider";
    ...
    public static void requireSoleLogyardProvider(ClassLoader classLoader) {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Logyard could not inspect SLF4J providers; add com.zsumz.logyard:logyard-slf4j2",
                    failure);
        }
        ...
        if (!providers.equals(List.of(LOGYARD_PROVIDER))) {
            throw new IllegalStateException(
                    "Spring Boot requires Logyard to be the sole SLF4J provider, but found " + providers
                            + ". Keep com.zsumz.logyard:logyard-slf4j2, exclude "
