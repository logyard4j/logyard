...
/** Minimal recursive-descent parser proving each emitted line is one complete JSON value. */
final class JsonRecordValidator {
    private final String source;
    private int cursor;

    private JsonRecordValidator(String source) {
        this.source = source;
    }

    static void requireValid(String source) {
        JsonRecordValidator validator = new JsonRecordValidator(source);
        validator.value();
