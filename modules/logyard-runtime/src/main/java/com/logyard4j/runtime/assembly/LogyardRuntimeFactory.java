...
import com.logyard4j.runtime.assembly.output.EncoderResolver;
import com.logyard4j.runtime.assembly.output.FormatterResolver;
import com.logyard4j.runtime.assembly.output.AssembledOutputs;
import com.logyard4j.runtime.assembly.output.OutputAssembler;
import com.logyard4j.runtime.assembly.output.OutputFactory;
import com.logyard4j.runtime.assembly.processing.ProcessorAssembler;
import com.logyard4j.runtime.assembly.routing.ConfiguredLoggerRuleResolver;
import com.logyard4j.runtime.extension.ExtensionRegistry;
import com.logyard4j.runtime.extension.discovery.ContextProviderDiscovery;
...
public final class LogyardRuntimeFactory {
    ...
    public static RuntimeAssembly assemble(LogyardConfig config, RuntimeAssembly current) {
        ...
        try {
            ...
            Map<String, com.logyard4j.api.Level> configuredLevels = new LinkedHashMap<>();
