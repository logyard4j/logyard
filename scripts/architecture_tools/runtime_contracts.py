...
def _check_bound_contracts(root: Path, state: CheckState) -> None:
    contracts = {
        ...
        "modules/logyard-output-json/src/main/java/com/zsumz/logyard/output/json/flush/FlushDiagnostics.java": ("private final AtomicBoolean reportInFlight", "new Thread(null, () -> write(failure), REPORTER_NAME, 0L, false)", "reporter.setDaemon(true)", "reporter.setContextClassLoader(null)"),
