...
def _check_reload_coordination(root: Path, state: CheckState) -> None:
    coordinator = root / "modules/logyard-runtime/src/main/java/com/zsumz/logyard/runtime/reload/coordination/ReloadCoordinator.java"
    ...
    reload_state = root / "modules/logyard-runtime/src/main/java/com/zsumz/logyard/runtime/reload/coordination/ReloadState.java"
    ...
    installation = root / "modules/logyard-runtime/src/main/java/com/zsumz/logyard/runtime/installation/ManagedRuntimeInstallation.java"
...
def _check_failure_boundaries(root: Path, state: CheckState) -> None:
    contracts = {
        "modules/logyard-core/src/main/java/com/zsumz/logyard/core/delivery/async/AsyncDelegateDelivery.java": "ComponentInvocationBoundary.invoke(",
        "modules/logyard-core/src/main/java/com/zsumz/logyard/core/delivery/async/AsyncSinkHealth.java": "ComponentInvocationBoundary.invoke(",
        "modules/logyard-core/src/main/java/com/zsumz/logyard/core/runtime/retirement/RetirementExecutor.java": "ComponentInvocationBoundary.report(",
        "modules/logyard-core/src/main/java/com/zsumz/logyard/core/runtime/management/RuntimeHealthReporter.java": "ComponentInvocationBoundary.invoke(",
        "modules/logyard-core/src/main/java/com/zsumz/logyard/core/runtime/retirement/RuntimeOutputs.java": "ComponentInvocationBoundary.invoke(",
        "modules/logyard-runtime/src/main/java/com/zsumz/logyard/runtime/assembly/output/EventSinkCleanup.java": "ComponentInvocationBoundary.invoke(",
        "modules/logyard-runtime/src/main/java/com/zsumz/logyard/runtime/assembly/output/OutputFactory.java": "ComponentInvocationBoundary.call(",
        "modules/logyard-runtime/src/main/java/com/zsumz/logyard/runtime/assembly/output/EncoderResolver.java": "ComponentInvocationBoundary.call(",
        "modules/logyard-runtime/src/main/java/com/zsumz/logyard/runtime/assembly/output/FormatterResolver.java": "ComponentInvocationBoundary.call(",
        "modules/logyard-runtime/src/main/java/com/zsumz/logyard/runtime/assembly/processing/ProcessorAssembler.java": "ComponentInvocationBoundary.call(",
        "modules/logyard-runtime/src/main/java/com/zsumz/logyard/runtime/extension/ProviderResolver.java": "ComponentInvocationBoundary.call(",
        "modules/logyard-runtime/src/main/java/com/zsumz/logyard/runtime/reload/watcher/ConfigurationWatchLoop.java": "ComponentInvocationBoundary.invoke(",
    }
...
def _check_bound_contracts(root: Path, state: CheckState) -> None:
    contracts = {
        ...
        "modules/logyard-config-toml/src/main/java/com/zsumz/logyard/config/loading/compiler/OutputSectionDecoder.java": ("static final int MAXIMUM_OUTPUTS = 128", "raw.size() > MAXIMUM_OUTPUTS"),
        "modules/logyard-output-json/src/main/java/com/zsumz/logyard/output/json/encoding/JsonEncoder.java": ("public synchronized String encode(LogEvent event)",),
        "modules/logyard-runtime/src/main/java/com/zsumz/logyard/runtime/extension/ExtensionGuardrails.java": ("EventEncoderBoundary.guard(delegate)",),
        "modules/logyard-output-json/src/main/java/com/zsumz/logyard/output/json/flush/SharedFlushScheduler.java": ("new ScheduledThreadPoolExecutor(2", "setRemoveOnCancelPolicy(true)"),
        "modules/logyard-output-json/src/main/java/com/zsumz/logyard/output/json/flush/TimedFlushController.java": ("dispatcher.dispatch(() -> runDispatched(due))",),
        "modules/logyard-output-json/src/main/java/com/zsumz/logyard/output/json/flush/FlushDiagnostics.java": ("private final AtomicReference<ReporterPhase> reporterPhase", "new Thread(null, () -> write(failure), REPORTER_NAME, 0L, false)", "reporter.setDaemon(true)", "reporter.setContextClassLoader(null)"),
        "modules/logyard-output-json/src/main/java/com/zsumz/logyard/output/json/flush/BoundedElasticFlushDispatcher.java": ("static final int MAXIMUM_WORKERS = 128", "static final Duration DEFAULT_IDLE_TIMEOUT = Duration.ofSeconds(2L)", "new BoundedElasticFlushDispatcher(MAXIMUM_WORKERS, DEFAULT_IDLE_TIMEOUT)", "new ThreadPoolExecutor(", "new SynchronousQueue<>()", "new Thread(", "thread.setDaemon(true)", "thread.setContextClassLoader(null)"),
        "modules/logyard-core/src/main/java/com/zsumz/logyard/core/processing/RateLimitProcessor.java": ("maxKeys > 4_096", "buckets.size() >= maxKeys"),
    }
...
def _check_flush_capacity(root: Path, state: CheckState) -> None:
    output_limit = _integer_constant(root, "modules/logyard-config-toml/src/main/java/com/zsumz/logyard/config/loading/compiler/OutputSectionDecoder.java", "MAXIMUM_OUTPUTS", state)
    worker_limit = _integer_constant(root, "modules/logyard-output-json/src/main/java/com/zsumz/logyard/output/json/flush/BoundedElasticFlushDispatcher.java", "MAXIMUM_WORKERS", state)
    ...
    diagnostics = (root / "modules/logyard-output-json/src/main/java/com/zsumz/logyard/output/json/flush/FlushDiagnostics.java").read_text(encoding="utf-8")
