...
def check_package_layout(root: Path, state: CheckState) -> None:
    ...
    _check_exact_root(
        root,
        "modules/logyard-config-toml/src/main/java/com/logyard4j/logyard/config",
    ...
    _check_exact_root(
        root,
        "modules/logyard-config-toml/src/main/java/com/logyard4j/logyard/config/loading",
    ...
    _check_exact_root(
        root,
        "modules/logyard-output-console/src/main/java/com/logyard4j/logyard/output/console",
        {"ConsoleSink.java"},
    ...
    _check_exact_root(
        root,
        "modules/logyard-runtime/src/main/java/com/logyard4j/logyard/runtime/extension/discovery",
        {
    ...
    _check_exact_root(
        root,
        "modules/logyard-core/src/main/java/com/logyard4j/logyard/core/delivery",
    ...
    _check_exact_root(
        root,
        "modules/logyard-core/src/main/java/com/logyard4j/logyard/core/runtime",
        {
    ...
    _check_exact_root(
        root,
        "modules/logyard-runtime/src/main/java/com/logyard4j/logyard/runtime/reload",
    ...
    _check_exact_root(
        root,
        "modules/logyard-runtime/src/main/java/com/logyard4j/logyard/runtime/installation",
        {
    ...
    _check_exact_root(
        root,
        "modules/logyard-runtime/src/main/java/com/logyard4j/logyard/runtime/assembly",
...
def _check_spi_layout(root: Path, state: CheckState) -> None:
    spi_root = root / "modules/logyard-api/src/main/java/com/logyard4j/logyard/api/spi"
