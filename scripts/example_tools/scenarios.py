...
def spring_boot_example(
    ...
    controller = "com.logyard4j.logyard.examples.springboot.SpringBootExampleController"
    ...
    return HttpExample(
        ZoltExample(
            ...
            main_class="com.logyard4j.logyard.examples.springboot.SpringBootExampleApplication",
